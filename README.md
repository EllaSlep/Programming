...
- _1 course 1 semester:_
    ...
    5 lab | [Игра "Жизнь"](https://github.com/EllaSlep/Programming/blob/main/Life.c) | [Текст задания](#Life) <a id="up5"></a> [^файл]
    6 lab | [Архиватор]() | [Текст задания](#arc) <a id="up6"></a>

Для работы с лабараторными есть файлы: [5](https://github.com/EllaSlep/Programming/blob/main/Pulsar.bmp), 
...
#####Примечание
>Программа должна предусматривать исключительные ситуации, которые могут возникать во время ее работы и корректно их обрабатывать.[^файл]

[Вернуться](#up5)

[^файл]:Можете взять [файл](https://github.com/EllaSlep/Programming/blob/main/Pulsar.bmp)
