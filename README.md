...
- _1 course 1 semester:_
    ...
    :------- |:----------------:| ---------------:
    1 lab | [Тип данных uint1024_t](https://github.com/EllaSlep/Programming/blob/main/uint1024_t.c) | [Текст задачи](#uint1024_t) <a id="up1"></a>
    2 lab | [Функция Word Cont](https://github.com/EllaSlep/Programming/blob/main/uint1024_t.c) | [Текст задачи](#WordCont) <a id="up2"></a>
    3 lab | [Анализ файла](https://github.com/EllaSlep/Programming/blob/main/analiz2.c) | [Текст задачи](#Analiz) <a id="up3"></a>
    4 lab | [Чтение mp3](https://github.com/EllaSlep/Programming/blob/main/mp3_reader2.c) | [Текст задачи](#mp3_reader) <a id="up4"></a>
